...
impl<T: Body + 'static, E: Into<Box<dyn std::error::Error + Send + Sync>> + 'static> RouterService<T, E> {
...
impl<T: Body + 'static, E: Into<Box<dyn std::error::Error + Send + Sync>> + 'static> Service<&TcpStream>
